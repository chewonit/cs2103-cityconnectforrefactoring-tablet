...
public class CityConnect {
	 ...
	 * 
	 * @param existingStartLocation	Name of start location from array.
	 * @param existingEndLocation	Name of end location from array.
	 * @param newStartLocation		Name of start location from input.
	 * @param newEndLocation		Name of end location from input.
	 * @return
	 */
